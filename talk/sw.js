'use strict';
const CACHE='hajun-talk-v3';
const ROOT=new URL('./',self.location.href);
const AUDIO=['this','water','price','card','thanks','excuse','slow','toilet','hotel','elevator','rest','arm','lost','ambulance'];
const CORE=['./','index.html','style.css?v=3','speech-player.js?v=3','app.js?v=3','phrases.js?v=1','manifest.webmanifest','icon.svg','../tokyo/assets/tokyo-diorama.webp',...AUDIO.map(x=>'../tokyo/assets/audio/'+x+'.mp3')].map(x=>new URL(x,ROOT).href);
